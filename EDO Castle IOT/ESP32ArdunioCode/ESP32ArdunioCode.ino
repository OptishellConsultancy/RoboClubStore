...
#define MQTT_PASS "aio_KlKc62h3ZrjiyAYykafW3rQkJXqC" // Adafruit IO Key is a string of characters that can be found by pressing the gold key button on your dashboard
